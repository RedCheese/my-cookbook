...
from windows.ingredient_list_window import IngredientListWindow
from utilities.utils import generate_id, working_directory
...
class CreateWindow(QWidget):   
    def __init__(self, main_window):
        ...
        self.ingredient_list_window = IngredientListWindow(self) # Initializing the Ingredient List Window
        ...
        self.ingredients_load_button = QPushButton("Load List")
        self.ingredients_load_button.setMaximumWidth(300)
        self.ingredients_load_button.setMinimumWidth(200)
        self.ingredients_load_button.clicked.connect(self.load_ingredient)
        ...
        self.ing_btn_group.addWidget(self.ingredients_load_button)
    ...
    def load_ingredient(self):
        """
        Function called by the Load Ingredient List button to show/hide the Ingredients List Window
        """
        if self.ingredient_list_window.isVisible():
            self.ingredient_list_window.hide()

        else:
            self.ingredient_list_window.show()
